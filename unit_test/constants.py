...
INTERACTION_MAPPING = '/home/Assignment/01_data_pipeline/unit_test/interaction_mapping.csv'
...
INDEX_COLUMNS_INFERENCE = ['created_date','city_tier', 'first_platform_c','first_utm_medium_c', 'first_utm_source_c', 'total_leads_droppped', 'referred_lead', 'app_complete_flag']
